...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_root', default='/path/to/dataset', type=str, help='data path')
    ...
    parser.add_argument('--test_path1', type=str,
                        default='/path/to/dataset/TestDataset/CVC-ClinicDB', help='path to test dataset')
    parser.add_argument('--test_path2', type=str,
                        default='/path/to/dataset/TestDataset/Kvasir', help='path to test dataset')
    parser.add_argument('--test_path3', type=str,
                        default='/path/to/dataset/TestDataset/CVC-ColonDB',help='path to test dataset')
    parser.add_argument('--test_path4', type=str,
                        default='/path/to/dataset/TestDataset/ETIS-LaribPolypDB',help='path to test dataset')
    parser.add_argument('--test_path5', type=str,
                        default='/path/to/dataset/TestDataset/CVC-300',help='path to test dataset')
